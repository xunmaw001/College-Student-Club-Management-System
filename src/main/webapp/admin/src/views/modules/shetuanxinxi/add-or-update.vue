<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="社团类别" prop="shetuanleibie">
          <el-select v-model="ruleForm.shetuanleibie" placeholder="请选择社团类别">
            <el-option
                v-for="(item,index) in shetuanleibieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shetuanjieshao = this.ruleForm.shetuanjieshao.replace(reg,'../../../ssm72axv/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
